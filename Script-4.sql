...
--NESTE INSERT ABAIXO INSERIMOS NOVAS SOLICITACOES PARA SER ENVIADA PARA ANALISE DE UM ANALISTA
INSERT INTO SOLICITACAO (DATA_CRIACAO, STATUS, USUARIO_ID, ANALISTA_ID, PRODUTO_ID)
VALUES (now(),'Em processamento', 3, 20, 3);

--NO SELECT ABAIXO BUSCAMOS AS SOLICITACOES, DA MAIS ANTIGA PARA A MAIS RECENTE, PARA UM ANALISTA AVALIAR
...
--RODE O SELECT ABAIXO PREENCHENDO O ID NO WHERE PARA VISUALIZAR A QUAL USUARIO O PRODUTO CARTAO PERTENCE.
